...
const PromotionalVideoDetails = ({ details }: { details: any }) => (
    <Paper sx={{ p: 2, bgcolor: 'grey.50', mt: 3 }}>
        <Typography variant="h6" gutterBottom>جزئیات اختصاصی: ویدئو تبلیغاتی</Typography>
...
export default PromotionalVideoDetails;