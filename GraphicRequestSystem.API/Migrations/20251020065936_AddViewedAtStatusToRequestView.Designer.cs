...
namespace GraphicRequestSystem.API.Migrations
{
    ...
    [Migration("20251020065936_AddViewedAtStatusToRequestView")]
    partial class AddViewedAtStatusToRequestView
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GraphicRequestSystem.API.Core.Entities.RequestView", b =>
                {
                    ...
                    b.HasIndex("UserId", "RequestId", "ViewedAtStatus")
                        .IsUnique();
